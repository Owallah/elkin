        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h3 className="font-display text-lg font-bold text-foreground mb-4">
              ELKIN<span className="text-accent">GROUP</span>
            </h3>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your trusted partner in transport, logistics, freight, and forwarding across East Africa and beyond.
            </p>
          </div>
          <div>
            <h4 className="font-display text-sm font-semibold text-foreground mb-4 uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              {["/", "/about", "/gallery", "/faqs", "/contact"].map((to, i) => (
                <li key={to}>
                  <Link href={to} className="hover:text-accent transition-colors">
                    {["Home", "About", "Gallery", "FAQs", "Contact"][i]}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>Moi Avenue, Mombasa</li>
              <li>Kenya, East Africa</li>
              <li>+254208100038</li>
              <li>info@elkingroup.co.ke</li>
            </ul>
          </div>
        </div>
        <div className="mt-12 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} Elkin Group. All rights reserved.
        </div>
      </div>
    </footer>
  );
